...
(defn title [] [:h1 (s/use-style {:font-size      "19vw"
                                  :letter-spacing "-0.075em"
                                  :line-height    "0.75"
                                  :margin-bottom  "0.5em"}) "James Acklin, "
